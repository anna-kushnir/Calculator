...
private: System::Windows::Forms::ToolStripMenuItem^ saveInput;
private: System::Windows::Forms::ToolStripMenuItem^ openInput;
...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->saveInput = (gcnew System::Windows::Forms::ToolStripMenuItem());
			   this->openInput = (gcnew System::Windows::Forms::ToolStripMenuItem());
			   ...
			   // menuMain
			   // 
			   this->menuMain->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(6) {
				   this->menuClear,
					   this->menuSaveResult, this->menuSaveResultAs, this->menuSeeLast, this->saveInput, this->openInput
			   });
			   ...
			   // saveInput
			   // 
			   this->saveInput->Name = L"saveInput";
			   this->saveInput->ShortcutKeys = static_cast<System::Windows::Forms::Keys>((System::Windows::Forms::Keys::Control | System::Windows::Forms::Keys::F12));
			   this->saveInput->Size = System::Drawing::Size(378, 22);
			   this->saveInput->Text = L"Зберегти введену задачу";
			   this->saveInput->Click += gcnew System::EventHandler(this, &Calculator_Form::saveInput_Click);
			   // 
			   // openInput
			   // 
			   this->openInput->Name = L"openInput";
			   this->openInput->ShortcutKeys = static_cast<System::Windows::Forms::Keys>((System::Windows::Forms::Keys::Control | System::Windows::Forms::Keys::F10));
			   this->openInput->Size = System::Drawing::Size(378, 22);
			   this->openInput->Text = L"Відкрити збережену задачу";
			   this->openInput->Click += gcnew System::EventHandler(this, &Calculator_Form::openInput_Click);
			   // 
			   // menuInfo
			   // 
...
#pragma endregion
	...
	private: System::Void saveInput_Click(System::Object^ sender, System::EventArgs^ e);
	private: System::Void openInput_Click(System::Object^ sender, System::EventArgs^ e);
};
}
